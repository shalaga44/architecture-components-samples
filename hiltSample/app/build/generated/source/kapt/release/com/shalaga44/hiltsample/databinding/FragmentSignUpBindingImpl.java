...
import com.shalaga44.hiltsample.BR;
...
public class FragmentSignUpBindingImpl extends FragmentSignUpBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.shalaga44.hiltsample.ui.signup.SignUpViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.shalaga44.hiltsample.ui.signup.SignUpViewModel ViewModel) {
